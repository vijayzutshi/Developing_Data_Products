...
# MPG and transmission types using mtcars dataset.  

library(markdown) 
shinyUI(navbarPage("Select the cars based on Following Categories", 
          tabPanel("Table", 
          # Sidebar 
          sidebarLayout( 
                sidebarPanel( 
                helpText("Provide information about cars that you want to purchase"), 
